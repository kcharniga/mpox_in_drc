my_simOutbreak <- 
  function (R0, # the reproduction number
            ...
            custom_kernel,
            #duration = 2922, # number of time steps to run the simulation over. Assuming units are in days, running simulation for 8 years
            duration = 1826, # number of time steps. (days) Running for 5 years
            ...
            import_rate = 0.3969884) # importation rate per time step, 145/365.25
            #import_rate = 0.3915127) # importation rate per time step, 143/365.25
  {
